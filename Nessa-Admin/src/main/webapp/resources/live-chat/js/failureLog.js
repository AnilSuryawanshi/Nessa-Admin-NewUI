...
/*setTimeout(function(){ 
   ...
   var location = "";
	...
	e.preventDefault();
	 ...
	 var sessionId= $("#sessionId").val();
        ipAddress = "http://localhost:8085/Nessa-Admin/getFailureLogById?sessionId="+sessionId;
    	...
    	var nessadialog=data.nessaQuestion;
    	var userdialog=data.userUtterence;
		var agent="";
			
		
		if(nessadialog!=null&&nessadialog!=""){

userUtterDiv ='<li class="mar-btm systemUtterance"> <div class="media-body pad-hor"> <div class="speech"><p id="systemUtterance">' + nessadialog  + '</p><p></p> </div></div></li>';
$("#utterance").append(userUtterDiv);

}else(userdialog!=null&&userdialog!="")

agentUtterDiv = '<li class="mar-btm userUtterance"><div class="media-body pad-hor speech-right"><div class="speech"><p id="userUtteranceValue">' + userdialog + '</p></div></div></li>';
	$("#utterance").append(agentUtterDiv);


	userUtterDiv ='<li class="mar-btm systemUtterance"> <div class="media-body pad-hor"> <div class="speech"><p id="systemUtterance">' + "Sorry, I did not understand that. Please try again."  + '</p><p></p> </div></div></li>';
	$("#utterance").append(userUtterDiv);
