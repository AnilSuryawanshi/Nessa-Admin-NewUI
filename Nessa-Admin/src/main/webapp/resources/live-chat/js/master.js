...
setTimeout(function(){ 
   ...
   var location = "";
	...
	e.preventDefault();
	 ...
	 var sessionId= $("#sessionId").val();
        ipAddress = "http://localhost:8085/ChatAPI/chat/readByInstanceId?instanceID="+sessionId;
		...
		if(dialog[i].chat!=null&&dialog[i].chat!=""){

userUtterDiv ='<li class="mar-btm systemUtterance"> <div class="media-body pad-hor"> <div class="speech"><p id="systemUtterance">' + dialog[i].chat  + '</p><p></p> </div></div></li>';
$("#utterance").append(userUtterDiv);

}else if(dialog[i].chatMsg!=null&&dialog[i].chatMsg!=""){

agentUtterDiv = '<li class="mar-btm userUtterance"><div class="media-body pad-hor speech-right"><div class="speech"><p id="userUtteranceValue">' + dialog[i].chatMsg + '</p></div></div></li>';
