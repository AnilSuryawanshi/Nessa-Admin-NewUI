...
%>
 ...
 <input type="hidden" id="sessionId" value="<%= request.getParameter("sessionId")%>">
    ...
    <div class="chat-wrapper ">
        ...
        <div id="header">
            ...
            <div class="panel-heading">
                <!--<div class="col-xs-2 col-md-1 nessa-logo"><img src="img/bot-logo.png" class="" alt="" /></div>-->
				 <div class="col-xs-2 col-md-1 nessa-logo"><img src="img/volvoLogo.png" class="" alt="" /></div>
      ...
      <script src="${pageContext.request.contextPath}/resources/live-chat/js/failureLog.js"></script>
