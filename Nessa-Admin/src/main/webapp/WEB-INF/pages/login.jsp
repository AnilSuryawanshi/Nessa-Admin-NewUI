...
<html lang="en">
    ...
    <head>
        ...
        <link href="${pageContext.request.contextPath}/resources/assets/pages/css/login-5.min.css" rel="stylesheet" type="text/css" />
        ...
        <div class="user-login-5">
            <div class="row bs-reset">
                <div class="col-md-6 login-container bs-reset">
                    <img class="login-logo login-6" src="${pageContext.request.contextPath}/resources/assets/pages/img/volvo-logo.png" alt="" height="100px" />
                    <div class="login-content">
                        <h1>WELCOME TO MY VOLVO</h1>
                        <p>Do you drive Volvo privately or as car? With My Volvo you will collect everything around the car.  The simple, more pleasing car life is just a click away.</p>
                        <form action="javascript:;" class="login-form" method="post">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-8 text-right">
                                    ...
                                    <a class="btn blue" type="submit" href="chat2.html">Sign In</a>
                                </div>
                            </div>
                        </form>
                    </div>
                        ...
                        <div class="row bs-reset">
                            ...
                            <div class="col-xs-7 bs-reset">
                                <div class="login-copyright text-right">
                                    <p>swedencr@volvocars.com or by phone 020-94 80 80.</p>
                                </div>
                            </div>
                        </div>
                    </div>
...
<![endif]-->
        ...
        <script src="${pageContext.request.contextPath}/resources/assets/pages/scripts/login-5.js" type="text/javascript"></script>
