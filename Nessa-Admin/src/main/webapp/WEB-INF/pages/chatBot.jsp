...
%>
 ...
 <input type="hidden" id="sessionId" value="<%= request.getParameter("sessionId")%>">
    ...
    <div class="chat-wrapper ">
        ...
        <div id="header">
            ...
            <div class="panel-heading">
                ...
                <div class="col-xs-10 col-md-10 padding-left-0">
					...
					<div id="test"><button id="closeBtn" onclick="closeChat()" style="top: 7px; right: 25px;position: absolute; font-size: large;background: #1d3356; border: 0;"/><i class="fa fa-times" aria-hidden="true"></i></button></div>
      ...
      <script src="${pageContext.request.contextPath}/resources/live-chat/js/master.js"></script>
...
var sessionId="<%= request.getParameter("sessionId")%>";
 ...
 setInterval(function(){
		$.ajax({
		        type: 'GET',
		url:'http://localhost:8085/Nessa-Admin/changeAgentStatus?sessionId='+sessionId+'&agentId=1234',
...
function closeChat(){
		 $.ajax({
		        type: 'GET',
		url:'http://localhost:8085/Nessa-Admin/closeChat?sessionId='+sessionId,
		        success: function(data){
